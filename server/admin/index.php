                            ...
                            <p>
								...
								if(($_GET['do']=="sel50")||($_GET['do']=="")){
                                    ...
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th>编号</th><th>规则名</th><th>员工名</th><th>时间范围</th><th>操作</th></tr>
                                        </thead>
                                        <tbody>
                                        <? 
										...
										?>
                                            <tr>
                                                ...
                                                <td>
                                              		  <a href="copy.php?rid=<? echo $sel50['rid']; ?>"><button type="button" class="btn btn-info">复制</button></a>
 ...
 <table class="table">
										...
										?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="copy.php?rid=<? echo $seld['rid']; ?>"><button type="button" class="btn btn-info">复制</button></a>
                            ...
                            <p>
                                 <div class="col-md-2">
                                    <ul class="nav nav-list">
                                        ...
                                        <li>
                                            <a href="excel.php"  target="view_window"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>导出到Excel</a>
                                        </li>
                                        <li>
                                        <?
